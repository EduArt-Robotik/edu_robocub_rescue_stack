...
def generate_launch_description():
    ...
    declare_mask_yaml_file = DeclareLaunchArgument(
        'mask',
        default_value=os.path.join(bringup_dir, 'keepout', 'keepout_filter.yaml')
    )
    ...
    #ld.add_action(start_amcl)  // currently started by life_cycle_node
    ...
    #ld.add_action(start_robot_localization_node)   // currently not in use
